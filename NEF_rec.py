...
def run_NEF_rec(dataset, sid, alpha, z, lambd, n_neurons=200, pretrain=False):
	...
	if pretrain:
		...
		for trial in trials:
			...
			W = simulate_NEF_rec(W, env, alpha=alpha, n_neurons=n_neurons, lambd=lambd, z=z, seed_net=sid, train=True)
